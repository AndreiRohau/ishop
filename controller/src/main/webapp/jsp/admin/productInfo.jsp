...
<head>
    ...
    <fmt:message bundle="${loc}" key="local.registrationForm" var="reg_form" />
    ...
    <fmt:message bundle="${loc}" key="local.nothingHappened" var="updateFailed" />
...
<c:if test="${requestScope.updateFailed == true}">
    <div class="panel-body">
        <div class="alert alert-info" role="alert" style="padding:15px">
            <h3><c:out value="${updateFailed}"/></h3>
        </div>
    </div>
</c:if>
